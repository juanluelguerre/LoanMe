...
using LoanMe.ApplicationBlocks.EventBus.Extensions;
...
namespace LoanMe.ApplicationBlocks.EventBusRabbitMQ
{
	public class EventBusRabbitMQ : IEventBus, IDisposable
	{
		const string BROKER_NAME = "loanme_event_bus";

		private readonly IRabbitMQPersistentConnection _persistentConnection;
		private readonly ILogger<EventBusRabbitMQ> _logger;
		private readonly IEventBusSubscriptionsManager _subsManager;
		// private readonly ILifetimeScope _autofac;
		// private readonly string AUTOFAC_SCOPE_NAME = "loanme_event_bus";
