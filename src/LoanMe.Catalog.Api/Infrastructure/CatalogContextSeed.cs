	...
	public class CatalogContextSeed
	{
		...
		private IEnumerable<CatalogItem> GetPreconfiguredItems()
		{
			return new List<CatalogItem>()
			{
				...
				new CatalogItem { CatalogTypeId = 2, CatalogBrandId = 2, AvailableStock = 1, Description = "Bugatti, the Worlds Most Expensive New Car In Motion", Name = "Bugatti the most expensive car.", Price = 12, PictureFileName = "4.png" },
				new CatalogItem { CatalogTypeId = 2, CatalogBrandId = 2, AvailableStock = 1, Description = "It’s a very exciting time for the TA2 Muscle Car Series at the moment.", Name = "TA2 Ford Mustang", Price = 8.5M, PictureFileName = "5.png" },
				new CatalogItem { CatalogTypeId = 2, CatalogBrandId = 6, AvailableStock = 1, Description = "For big girls and boys who like to play with even bigger toys, this is the perfect experience.", Name = "The Big One Monster Truck.", Price = 12, PictureFileName = "6.png" },
				new CatalogItem { CatalogTypeId = 2, CatalogBrandId = 5, AvailableStock = 1, Description = "The design space for a machine that can roll out of a standard parking spot, unfurl a pair of wings.", Name="Air plane car", Price = 12, PictureFileName = "7.png" },
				...
				new CatalogItem { CatalogTypeId = 2, CatalogBrandId = 3, AvailableStock = 1, Description = "You can choose from a range of UK locations to live out your transformers dream", Name = "Optimus Prime American Truck", Price = 12, PictureFileName = "10.png" },
